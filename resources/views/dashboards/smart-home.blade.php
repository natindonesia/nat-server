      ...
      <div class="card">
        <div class="card-header pb-0 p-3">
          <div class="d-flex align-items-center">
            <h6 class="mb-0">Summary : Kolam 1</h6>
            <button type="button" class="btn btn-icon-only btn-rounded btn-outline-secondary mb-0 ms-2 btn-sm d-flex align-items-center justify-content-center ms-auto" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Lihat kelayakan kolam">
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-0">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Salitity</h6>
                          </div>
                        </div>
                      </td>
                      <td class="align-middle text-center text-sm">
