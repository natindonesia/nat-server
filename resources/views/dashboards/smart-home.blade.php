...
@section('content')
  ...
  <div class="row mt-4"> <div class="col-lg-6 ms-auto"> <div class="card">
    <div class="card-header pb-0 p-3">
    <div class="d-flex align-items-center">
    <h6 class="mb-0">Consumption by Adult's Pool</h6>
    <button type="button" class="btn btn-icon-only btn-rounded btn-outline-secondary mb-0 ms-2 btn-sm d-flex
    align-items-center justify-content-center ms-auto" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Lihat
    kelayakan kolam">
    ...
    <div class="card-body p-3">
      ...
      <div class="chart">
      <canvas id="chart-consumption" class="chart-canvas" height="197" width="223" style="display: block; box-sizing: border-box; height: 197px; width: 223.9px; overflow-clip-margin: content-box; overflow: clip; overflow-x: 0; overflow-y: 0;"></canvas>
      </div>
      <h4 class="font-weight-bold mt-n8">
      <span>Baik</span>
        <span class="d-block text-body text-sm">Kolam siap digunakan </span>
      </h4>
    </div>
    <div class="col-7">
          ...
          <tbody>
            <tr>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold">27<sup>o</sup>C</span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 7.25pH </span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 25mg/l </span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 700mV </span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 500hS/cm </span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 230ppm </span>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="table align-items-center mb-0">
          <tbody>
            <tr>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold">26.5<sup>o</sup>C</span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 7.35pH </span>
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 670mV </span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 450hS/cm </span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 280ppm </span>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <table class="table align-items-center mb-0">
          <tbody>
            <tr>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold">30<sup>o</sup>C</span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 8.45pH </span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 20mg/l </span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 650mV </span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 650hS/cm </span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td class="align-right text-end text-sm">
                <span class="text-xs font-weight-bold"> 240ppm </span>
              </td>
            </tr>
          </tbody>
        </table>
