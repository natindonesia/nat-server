  ...
  <div class="row mt-4">
    <div class="col-12">
      <div class="card bg-gradient-secondary">
        <img src="{{ URL::asset('assets/img/shapes/waves-white.svg') }}" alt="pattern-lines" class="position-absolute opacity-4 start-0 top-0 w-100">
        <div class="card-body px-5 z-index-1 bg-cover">
          <div class="row">
            ...
            <div class="col-lg-6 col-12 text-center">
              <img class="w-75 w-lg-auto mt-n7 mt-lg-n8 d-none d-md-block" src="{{ URL::asset('assets/img/mercedes-eqc.png') }}" alt="car image">
              ...
              <div class="d-flex align-items-center">
                <div class="position-relative">
                  <div class="avatar avatar-lg">
                    <img src="{{ URL::asset('assets/img/curved-images/curved10.jpg') }}" alt="kal" class="border-radius-xl rounded-circle shadow">
                  </div>
                  <img class="position-absolute w-60 end-0 bottom-0 me-n3 mb-0" src="{{ URL::asset('assets/img/small-logos/logo-spotify.svg') }}" alt="spotify logo">
                </div>
                <div class="px-3">
...
@push('js')  
  <script src="{{ URL::asset('assets/js/plugins/leaflet.js') }}"></script>
