      ...
      <div class="multisteps-form mb-5">
        ...
        <div class="row">
          <div class="col-12 col-lg-8 m-auto">
            <form class="multisteps-form__form mb-8 add-edit-user" method="POST" action="/edit-step-three/{{$user->id}}" enctype="multipart/form-data">
              @csrf
              <!--single form panel-->
                ...
                <div class="multisteps-form__content">
                  ...
                  <div class="row">
                    <div class="button-row d-flex mt-4 col-12">
                      <a href="/edit-create-step-two/{{$user->id}}" class="btn bg-gradient-light mb-0 js-btn-prev">Prev</a>
