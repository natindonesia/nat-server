        ...
        <div class="row">
            <div class="col-9 mx-auto">
                <div class="card card-body mt-4">
                    ...
                    <form action="/laravel-new-category" method="POST">
                        @csrf
                        <div>
                            <label for="categoryName" class="form-label">Category Name</label>
                            <div class="">
                                <input type="text" class="form-control " value="{{ old('name') }}" id="categoryName" name="name" onfocus="focused(this)" onfocusout="defocused(this)">
                                @error('name')
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" name="button" class="btn bg-gradient-primary m-0 ms-2">CREATE CATEGORY</button>
                        </div>
                    </form>
                </div>
            </div>
